...
pub struct FunctionPtrs {
    pub uuv_editor_texel_density_settings_in_sampling_mode: *mut crate::ffi::UFunctionOpague,
}
impl FunctionPtrs {
    pub const fn empty() -> Self {
        Self {
            uuv_editor_texel_density_settings_in_sampling_mode: std::ptr::null_mut(),
        }
    }
}
pub fn initialize() {
    unsafe {
        ...
        if let Some(class_ptr) = UUVEditorTexelDensitySettings::try_static_class() {
            (bindings
                .core_fns
                ...
                &raw mut __FUNCTION_PTRS
                    .uuv_editor_texel_density_settings_in_sampling_mode,
            );
        }
    }
}
