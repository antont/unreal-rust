...
pub struct FFoliageDensityFalloff {
    ...
    pub falloff_curve: FRuntimeFloatCurve,
}
#[repr(C, align(8))]
pub struct FFoliageTypeObject {
    pub foliage_type_object: UPtr<UObject>,
...
pub struct UFoliageType {
    ...
    pub flags_168: u8,
    pub z_offset: FFloatInterval,
    pub flags_180: u8,
    pub align_max_angle: f32,
    pub flags_188: u8,
    pub random_pitch_angle: f32,
    pub ground_slope_angle: FFloatInterval,
    pub height: FFloatInterval,
    ...
    pub flags_272: u8,
    pub collision_scale: FVector,
    pub average_normal_sample_count: i32,
    pub mesh_bounds: FBoxSphereBounds,
    pub low_bound_origin_radius: FVector,
    pub mobility: EComponentMobility,
    pub cull_distance: FInt32Interval,
    pub flags_404: u8,
    pub flags_408: u8,
    pub flags_412: u8,
    ...
    pub custom_navigable_geometry: EHasCustomNavigableGeometry,
    ...
    pub procedural_scale: FFloatInterval,
    pub scale_curve: FRuntimeFloatCurve,
...
pub struct UFoliageType_InstancedStaticMesh {
    ...
    pub nanite_override_materials: TArray<UPtr<UMaterialInterface>>,
...
pub struct AInteractiveFoliageActor {
    ...
    pub touching_actor_entry_position: FVector,
    pub foliage_velocity: FVector,
    pub foliage_force: FVector,
    pub foliage_position: FVector,
...
pub struct UProceduralFoliageComponent {
    ...
    pub spawning_volume: UPtr<AVolume>,
    pub procedural_guid: FGuid,
}
pub struct UProceduralFoliageSpawner {
    ...
    pub override_foliage_terrain_materials: TArray<TSoftObjectPtr<UMaterialInterface>>,
}
