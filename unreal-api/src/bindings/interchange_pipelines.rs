...
pub struct FInterchangeLodSceneNodeContainer {
    pub base_nodes: TArray<UPtr<UInterchangeBaseNode>>,
}
#[repr(C, align(8))]
pub struct FInterchangeMeshInstance {
    pub mesh_instance_uid: FString,
    pub lod_group_node: UPtr<UInterchangeBaseNode>,
...
pub struct FInterchangeMeshGeometry {
    ...
    pub mesh_node: UPtr<UInterchangeMeshNode>,
...
pub struct UInterchangeGenericCommonSkeletalMeshesAndAnimationsProperties {
    ...
    pub skeleton: TWeakObjectPtr<USkeleton>,
    pub b_import_meshes_in_bone_hierarchy: bool,
...
pub struct UInterchangeGenericAssetsPipeline {
    ...
    pub reimport_strategy: EReimportStrategyFlags,
    ...
    pub import_offset_translation: FVector,
    pub import_offset_rotation: FRotator,
    ...
    pub content_path_existing_skeleton: FSoftObjectPath,
...
pub struct UInterchangeGenericAudioPipeline {
    ...
    pub source_datas: TArray<UPtr<UInterchangeSourceData>>,
    pub sound_wave_nodes: TArray<UPtr<UInterchangeAudioSoundWaveNode>>,
    pub sound_wave_factory_nodes: TArray<UPtr<UInterchangeAudioSoundWaveFactoryNode>>,
}
pub struct UInterchangeGenericGroomPipeline {
    pub pipeline_display_name: FString,
    pub b_enable_groom_types_import: bool,
    pub b_import_grooms: bool,
    pub group_interpolation_settings: FHairGroupsInterpolation,
    pub b_import_groom_caches: bool,
    pub groom_asset: FSoftObjectPath,
    pub import_groom_cache_type: EInterchangeGroomCacheImportType,
...
pub struct UInterchangeGenericMaterialPipeline {
    ...
    pub parent_material: FSoftObjectPath,
...
pub struct UInterchangeGenericMeshPipeline {
    ...
    pub collision: EInterchangeMeshCollision,
    ...
    pub distance_field_replacement_mesh: TWeakObjectPtr<UStaticMesh>,
    pub max_lumen_mesh_cards: i32,
    pub b_import_skeletal_meshes: bool,
    pub skeletal_mesh_import_content_type: EInterchangeSkeletalMeshContentType,
    pub last_skeletal_mesh_import_content_type: EInterchangeSkeletalMeshContentType,
    ...
    pub physics_asset: TWeakObjectPtr<UPhysicsAsset>,
    ...
    pub frame_start: i32,
    pub frame_end: i32,
    pub motion_vectors: EInterchangeMotionVectorsHandling,
...
pub struct UInterchangeGenericLevelPipeline {
    pub pipeline_display_name: FString,
    pub reimport_property_strategy: EReimportStrategyFlags,
...
pub struct UGLTFPipelineSettings {
    pub material_parents: TMap<FString, FSoftObjectPath>,
}
pub struct UInterchangeGLTFPipeline {
    pub pipeline_display_name: FString,
}
pub struct UMaterialXPipelineSettings {
    pub predefined_surface_shaders: TMap<EInterchangeMaterialXShaders, FSoftObjectPath>,
    pub predefined_bsdf: TMap<EInterchangeMaterialXBSDF, FSoftObjectPath>,
    pub predefined_edf: TMap<EInterchangeMaterialXEDF, FSoftObjectPath>,
    pub predefined_vdf: TMap<EInterchangeMaterialXVDF, FSoftObjectPath>,
}
