...
pub struct FSequencerFilterBarConfig {
    ...
    pub custom_text_filters: TArray<
        crate::bindings::tool_widgets::FCustomTextFilterData,
    >,
...
pub struct UMotionTrailToolOptions {
    ...
    pub default_color: crate::bindings::core_u_object::FLinearColor,
    pub time_pre_color: crate::bindings::core_u_object::FLinearColor,
    pub time_post_color: crate::bindings::core_u_object::FLinearColor,
    pub dash_pre_color: crate::bindings::core_u_object::FLinearColor,
    pub dash_post_color: crate::bindings::core_u_object::FLinearColor,
    ...
    pub key_color: crate::bindings::core_u_object::FLinearColor,
    pub selected_key_color: crate::bindings::core_u_object::FLinearColor,
    pub key_size: f64,
    pub b_show_marks: bool,
    pub mark_color: crate::bindings::core_u_object::FLinearColor,
    pub mark_size: f64,
...
pub struct UMovieSceneCopyableBinding {
    pub spawnable_object_templates: TArray<
        UPtr<crate::bindings::core_u_object::UObject>,
    >,
    pub num_spawnable_object_templates: i32,
    pub tracks: TArray<UPtr<crate::bindings::movie_scene::UMovieSceneTrack>>,
    pub binding: crate::bindings::movie_scene::FMovieSceneBinding,
    pub spawnable: crate::bindings::movie_scene::FMovieSceneSpawnable,
    pub possessable: crate::bindings::movie_scene::FMovieScenePossessable,
    pub bound_object_names: TArray<FString>,
    pub folder_path: TArray<FName>,
    pub tags: TArray<FName>,
    pub custom_bindings: TArray<
        UPtr<crate::bindings::movie_scene::UMovieSceneCustomBinding>,
    >,
    pub num_custom_bindings: i32,
    pub preview_spawnable_bindings: TArray<i32>,
}
pub struct UMovieSceneCopyableTrack {
    pub track: UPtr<crate::bindings::movie_scene::UMovieSceneTrack>,
...
pub struct USequencerSettings {
    ...
    pub key_interpolation: crate::bindings::movie_scene::EMovieSceneKeyInterpolation,
    ...
    pub curve_editor_zoom_scaling: crate::bindings::curve_editor::FCurveEditorZoomScaleConfig,
    ...
    pub jump_frame_increment: crate::bindings::core_u_object::FFrameNumber,
    ...
    pub playback_range_start_color: crate::bindings::core_u_object::FLinearColor,
    pub playback_range_end_color: crate::bindings::core_u_object::FLinearColor,
    pub marked_frame_color: crate::bindings::core_u_object::FLinearColor,
    pub section_color_tints: TArray<crate::bindings::core_u_object::FColor>,
    ...
    pub frame_number_display_format: crate::bindings::time_management::EFrameNumberDisplayFormats,
    ...
    pub sidebar_state: TMap<FName, crate::bindings::tool_widgets::FSidebarState>,
...
pub struct USequencerTimeChangeUndoRedoProxy {
    pub time: crate::bindings::core_u_object::FQualifiedFrameTime,
