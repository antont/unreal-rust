...
pub struct FHairMaterialConstraints {
    pub(crate) __padding_end: [u8; 472],
}
...
pub struct UGroomComponent {
    ...
    >,
    #[doc(hidden)]
    pub(crate) __padding_1880: [u8; 48],
    pub attachment_name: FString,
    #[doc(hidden)]
    pub(crate) __padding_2032: [u8; 136],
