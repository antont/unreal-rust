...
pub struct FHairGroupCardsTextures {
    ...
    pub depth_texture_deprecated: UPtr<UTexture2D>,
    pub coverage_texture_deprecated: UPtr<UTexture2D>,
    pub tangent_texture_deprecated: UPtr<UTexture2D>,
    pub attribute_texture_deprecated: UPtr<UTexture2D>,
    pub auxilary_data_texture_deprecated: UPtr<UTexture2D>,
    pub material_texture_deprecated: UPtr<UTexture2D>,
}
#[repr(C, align(8))]
pub struct FHairGroupsCardsSourceDescription {
    ...
    pub procedural_mesh_deprecated: UPtr<UStaticMesh>,
    pub b_invert_uv: bool,
    pub guide_type: EHairCardsGuideType,
    pub imported_mesh: UPtr<UStaticMesh>,
...
pub struct FGroomDataflowSettings {
    ...
    pub preview_animation_asset: TSoftObjectPtr<UAnimationAsset>,
}
#[repr(C, align(4))]
...
pub struct FHairSolverSettings {
    ...
    pub custom_system: TSoftObjectPtr<UNiagaraSystem>,
...
pub struct FHairExternalForces {
    pub gravity_vector: FVector,
    pub air_drag: f32,
    pub air_velocity: FVector,
}
#[repr(C, align(8))]
pub struct FHairBendConstraint {
    ...
    pub bend_scale: FRuntimeFloatCurve,
}
#[repr(C, align(8))]
pub struct FHairStretchConstraint {
    ...
    pub stretch_scale: FRuntimeFloatCurve,
}
#[repr(C, align(8))]
pub struct FHairCollisionConstraint {
    ...
    pub grid_dimension: FIntVector,
    pub collision_radius: f32,
    pub radius_scale: FRuntimeFloatCurve,
}
#[repr(C, align(8))]
...
pub struct FHairStrandsParameters {
    ...
    pub thickness_scale: FRuntimeFloatCurve,
}
#[repr(C, align(8))]
...
pub struct UGroomAsset {
    ...
    pub rigged_skeletal_mesh: UPtr<USkeletalMesh>,
...
pub struct UGroomBindingAsset {
    ...
    pub source_geometry_cache: UPtr<UGeometryCache>,
    pub target_geometry_cache: UPtr<UGeometryCache>,
...
pub struct UGroomComponent {
    ...
    pub groom_cache: UPtr<UGroomCache>,
    pub niagara_components: TArray<UPtr<UNiagaraComponent>>,
    pub source_skeletal_mesh: UPtr<USkeletalMesh>,
    pub binding_asset: UPtr<UGroomBindingAsset>,
    ...
    pub strands_debug_material: UPtr<UMaterialInterface>,
    pub strands_default_material: UPtr<UMaterialInterface>,
    pub cards_default_material: UPtr<UMaterialInterface>,
    pub meshes_default_material: UPtr<UMaterialInterface>,
    pub angular_springs_system: UPtr<UNiagaraSystem>,
    pub cosserat_rods_system: UPtr<UNiagaraSystem>,
...
pub struct UGroomCreateStrandsTexturesOptions {
    ...
    pub dilation: i32,
    pub generated_textures: TArray<UPtr<UTexture2D>>,
}
...
pub struct UNiagaraDataInterfaceHairStrands {
    ...
    pub source_actor: UPtr<AActor>,
}
pub struct UNiagaraDataInterfaceVelocityGrid {
    pub grid_size: FIntVector,
}
