...
pub struct FGrassVariety {
    pub grass_mesh: UPtr<UStaticMesh>,
    pub override_materials: TArray<UPtr<UMaterialInterface>>,
    pub grass_density: FPerPlatformFloat,
    pub grass_density_quality: FPerQualityLevelFloat,
    pub b_use_grid: bool,
    pub placement_jitter: f32,
    pub start_cull_distance: FPerPlatformInt,
    pub start_cull_distance_quality: FPerQualityLevelInt,
    pub end_cull_distance: FPerPlatformInt,
    pub end_cull_distance_quality: FPerQualityLevelInt,
    pub min_lod: i32,
    pub allowed_density_range: FFloatInterval,
    pub scaling: EGrassScaling,
    pub scale_x: FFloatInterval,
    pub scale_y: FFloatInterval,
    pub scale_z: FFloatInterval,
...
pub struct FForeignSplineSegmentData {
    pub modification_key: FGuid,
    pub mesh_components: TArray<UPtr<USplineMeshComponent>>,
...
pub struct FLandscapeSplineInterpPoint {
    ...
    pub left: FVector,
    pub right: FVector,
    pub falloff_left: FVector,
    pub falloff_right: FVector,
    pub layer_left: FVector,
    pub layer_right: FVector,
    pub layer_falloff_left: FVector,
    pub layer_falloff_right: FVector,
...
pub struct FLandscapeSplineMeshEntry {
    ...
    pub material_overrides: TArray<UPtr<UMaterialInterface>>,
    pub flags_24: u8,
    pub center_adjust: FVector2D,
    pub flags_48: u8,
    pub scale: FVector,
    pub orientation_deprecated: LandscapeSplineMeshOrientation,
    pub forward_axis: ESplineMeshAxis,
    pub up_axis: ESplineMeshAxis,
}
#[repr(C, align(8))]
...
pub struct FLandscapeBrushParameters {
    pub render_area_world_transform: FTransform,
    pub render_area_size: FIntPoint,
    pub combined_result: UPtr<UTextureRenderTarget2D>,
    pub layer_type: ELandscapeToolTargetType,
    pub weightmap_layer_name: FName,
}
#[repr(C, align(8))]
pub struct FLandscapeEditToolRenderData {
    pub tool_material: UPtr<UMaterialInterface>,
    ...
    pub data_texture: UPtr<UTexture2D>,
    pub layer_contribution_texture: UPtr<UTexture2D>,
    pub dirty_texture: UPtr<UTexture2D>,
}
#[repr(C, align(8))]
...
pub struct FLandscapeInfoLayerSettings {
    ...
    pub thumbnail_mic: UPtr<UMaterialInstanceConstant>,
...
pub struct FLayerBlendInput {
    ...
    pub layer_input: FExpressionInput,
    pub height_input: FExpressionInput,
    pub preview_weight: f32,
    pub const_layer_input: FVector,
    pub const_height_input: f32,
}
#[repr(C, align(8))]
pub struct FPhysicalMaterialInput {
    pub physical_material: UPtr<UPhysicalMaterial>,
    pub input: FExpressionInput,
}
...
pub struct ALandscapeGizmoActiveActor {
    ...
    pub gizmo_texture: UPtr<UTexture2D>,
    pub texture_scale: FVector2D,
    pub sampled_height: TArray<FVector>,
    pub sampled_normal: TArray<FVector>,
    pub sample_size_x: i32,
    pub sample_size_y: i32,
    pub cached_width: f32,
    pub cached_height: f32,
    pub cached_scale_xy: f32,
    pub frustum_verts: FVector,
    pub gizmo_material: UPtr<UMaterial>,
    pub gizmo_data_material: UPtr<UMaterialInstance>,
    pub gizmo_mesh_material: UPtr<UMaterial>,
    ...
    pub unsnapped_rotation: FRotator,
}
...
pub struct ULandscapeGrassType {
    ...
    pub flags_64: u8,
    pub state_hash: u32,
    pub grass_mesh_deprecated: UPtr<UStaticMesh>,
...
pub struct ALandscapeProxy {
    ...
    pub landscape_guid: FGuid,
    pub original_landscape_guid: FGuid,
    ...
    pub scalable_lod0_screen_size: FPerQualityLevelFloat,
    pub scalable_lod0_distribution_setting: FPerQualityLevelFloat,
    pub scalable_lod_distribution_setting: FPerQualityLevelFloat,
    ...
    pub landscape_hole_material: UPtr<UMaterialInterface>,
    pub landscape_materials_override_deprecated: TArray<FLandscapeProxyMaterialOverride>,
    pub pre_edit_landscape_material_deprecated: UPtr<UMaterialInterface>,
    pub pre_edit_landscape_hole_material_deprecated: UPtr<UMaterialInterface>,
    ...
    pub foliage_components: TArray<UPtr<UHierarchicalInstancedStaticMeshComponent>>,
    ...
    pub reimport_destination_layer_guid: FGuid,
    pub editor_layer_settings_deprecated: TArray<FLandscapeEditorLayerSettings>,
    pub weightmap_usage_map: TMap<UPtr<UTexture2D>, UPtr<ULandscapeWeightmapUsage>>,
    ...
    pub hlod_material_override: UPtr<UMaterialInterface>,
...
pub struct ULandscapeHeightfieldCollisionComponent {
    ...
    pub heightfield_guid: FGuid,
    pub cached_local_box: FBox,
    ...
    pub physical_material_render_objects: TArray<UPtr<UPhysicalMaterial>>,
    pub cooked_physical_materials: TArray<UPtr<UPhysicalMaterial>>,
}
...
pub struct ULandscapeMeshProxyComponent {
    pub landscape_guid: FGuid,
    pub proxy_component_bases: TArray<FIntPoint>,
    pub proxy_component_centers_object_space: TArray<FVector>,
    pub component_x_vector_object_space: FVector,
    pub component_y_vector_object_space: FVector,
...
pub struct ULandscapeSplinesComponent {
    ...
    pub spline_color: FColor,
    pub control_point_sprite: UPtr<UTexture2D>,
    pub spline_editor_mesh: UPtr<UStaticMesh>,
    pub flags_1528: u8,
    ...
    >,
    pub cooked_foreign_mesh_components: TArray<UPtr<UMeshComponent>>,
}
pub struct ULandscapeSplineControlPoint {
    ...
    pub foreign_world: TSoftObjectPtr<UWorld>,
    pub modification_key: FGuid,
}
pub struct ULandscapeSplineSegment {
    ...
    pub points: TArray<FLandscapeSplineInterpPoint>,
    pub bounds: FBox,
    pub local_mesh_components: TArray<UPtr<USplineMeshComponent>>,
    pub foreign_worlds: TArray<TSoftObjectPtr<UWorld>>,
    pub modification_key: FGuid,
}
...
pub struct ALandscape {
    ...
    pub landscape_splines_target_layer_guid_deprecated: FGuid,
    ...
    pub heightmap_rt_list_deprecated: TArray<UPtr<UTextureRenderTarget2D>>,
    pub weightmap_rt_list_deprecated: TArray<UPtr<UTextureRenderTarget2D>>,
    pub tracked_streaming_in_textures: TArray<TWeakObjectPtr<UTexture2D>>,
...
pub struct ULandscapeComponent {
    ...
    pub override_hole_material: UPtr<UMaterialInterface>,
    pub override_materials_deprecated: TArray<FLandscapeComponentMaterialOverride>,
    pub material_instance_deprecated: UPtr<UMaterialInstanceConstant>,
    pub material_instances: TArray<UPtr<UMaterialInstanceConstant>>,
    pub material_instances_dynamic: TArray<UPtr<UMaterialInstanceDynamic>>,
    pub lod_index_to_material_index: TArray<i8>,
    pub xy_offsetmap_texture_deprecated: UPtr<UTexture2D>,
    pub weightmap_scale_bias: FVector4,
    pub weightmap_subsection_offset: f32,
    pub heightmap_scale_bias: FVector4,
    pub cached_local_box: FBox,
    ...
    pub layers_data: TMap<FGuid, FLandscapeLayerComponentData>,
    pub obsolete_edit_layer_data: TMap<FGuid, FLandscapeLayerComponentData>,
    ...
    pub heightmap_texture: UPtr<UTexture2D>,
    pub weightmap_layer_allocations: TArray<FWeightmapLayerAllocationInfo>,
    pub weightmap_textures: TArray<UPtr<UTexture2D>>,
    pub per_lod_override_materials: TArray<FLandscapePerLODMaterialOverride>,
    ...
    pub mobile_data_source_hash: FGuid,
    pub material_per_lod: TMap<UPtr<UMaterialInterface>, i8>,
    pub spline_hash: u32,
    pub physical_material_hash: u32,
    pub last_saved_physical_material_hash: u32,
    pub mobile_material_interface_deprecated: UPtr<UMaterialInterface>,
    pub mobile_combination_material_instance_deprecated: UPtr<UMaterialInstanceConstant>,
    pub mobile_material_interfaces: TArray<UPtr<UMaterialInterface>>,
    pub mobile_weightmap_textures: TArray<UPtr<UTexture2D>>,
    pub mobile_weightmap_texture_array: UPtr<UTexture2DArray>,
    pub mobile_weightmap_layer_allocations: TArray<FWeightmapLayerAllocationInfo>,
    pub mobile_combination_material_instances: TArray<UPtr<UMaterialInstanceConstant>>,
}
...
pub struct ULandscapeScratchRenderTarget {
    pub render_target: UPtr<UTextureRenderTarget>,
}
pub struct ULandscapeEditResourcesSubsystem {
    pub scratch_render_targets: TArray<UPtr<ULandscapeScratchRenderTarget>>,
    pub layer_debug_color_material: UPtr<UMaterialInterface>,
    pub selection_color_material: UPtr<UMaterialInterface>,
    pub selection_region_material: UPtr<UMaterialInterface>,
    pub mask_region_material: UPtr<UMaterialInterface>,
    pub color_mask_region_material: UPtr<UMaterialInterface>,
    pub landscape_black_texture: UPtr<UTexture2D>,
    pub landscape_layer_usage_material: UPtr<UMaterialInterface>,
    pub landscape_dirty_material: UPtr<UMaterialInterface>,
}
...
pub struct ULandscapeLayerInfoObject {
    ...
    pub flags_80: u8,
    pub spline_falloff_modulation_texture: UPtr<UTexture2D>,
...
pub struct ULandscapeSettings {
    ...
    pub default_landscape_material: TSoftObjectPtr<UMaterialInterface>,
...
pub struct ULandscapeTextureHash {
    pub texture_hash_guid: FGuid,
    pub last_source_id: FGuid,
...
pub struct UMaterialExpressionLandscapeLayerSwitch {
    pub layer_used: FExpressionInput,
    pub layer_not_used: FExpressionInput,
    pub parameter_name: FName,
    pub flags_308: u8,
}
pub struct UMaterialExpressionLandscapeLayerWeight {
    pub base: FExpressionInput,
    pub layer: FExpressionInput,
    pub parameter_name: FName,
    pub preview_weight: f32,
    pub const_base: FVector,
}
