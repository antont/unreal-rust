...
impl UNNERuntimeORTDml_GPU_RDG_NPU {
    ...
    > {
        let ptr = *crate::bindings::globals::CLASS_PTRS
            .wait()
            .name_to_ptr
            .get("UNNERuntimeORTDml_GPU_RDG_NPU")
            .unwrap();
        crate::core_data::UPtr {
            ptr: ptr.cast(),
        }
