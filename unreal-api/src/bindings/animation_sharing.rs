...
pub struct FAnimationSetup {
    ...
    pub num_randomized_instances: FPerPlatformInt,
    pub enabled: FPerPlatformBool,
}
#[repr(C, align(8))]
pub struct FAnimationStateEntry {
    ...
    pub next_state: u8,
    pub maximum_number_of_concurrent_instances: FPerPlatformInt,
...
pub struct FAnimationSharingScalability {
    pub use_blend_transitions: FPerPlatformBool,
    pub blend_significance_value: FPerPlatformFloat,
    pub maximum_number_concurrent_blends: FPerPlatformInt,
    pub tick_significance_value: FPerPlatformFloat,
}
#[repr(C, align(8))]
pub struct FTickAnimationSharingFunction {}
pub struct UAnimationSharingStateProcessor {
    pub animation_state_enum: TSoftObjectPtr<UEnum>,
}
pub struct UAnimSharingStateInstance {
    pub animation_to_play: UPtr<UAnimSequence>,
...
pub struct UAnimSharingTransitionInstance {
    pub from_component: TWeakObjectPtr<USkeletalMeshComponent>,
    pub to_component: TWeakObjectPtr<USkeletalMeshComponent>,
    pub blend_time: f32,
    pub b_blend_bool: bool,
}
pub struct UAnimSharingAdditiveInstance {
    pub base_component: TWeakObjectPtr<USkeletalMeshComponent>,
    pub additive_animation: TWeakObjectPtr<UAnimSequence>,
    pub alpha: f32,
    pub b_state_bool: bool,
}
pub struct UAnimSharingInstance {
    pub registered_actors: TArray<UPtr<AActor>>,
    pub state_processor: UPtr<UAnimationSharingStateProcessor>,
    pub used_animation_sequences: TArray<UPtr<UAnimSequence>>,
    pub state_enum: UPtr<UEnum>,
    pub sharing_actor: UPtr<AActor>,
}
pub struct UAnimationSharingManager {
    pub skeletons: TArray<UPtr<USkeleton>>,
